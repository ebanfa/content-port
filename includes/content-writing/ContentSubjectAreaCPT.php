...
class ContentSubjectAreaCPT {

    public static $prefix = ''; 

	public static $custom_fields =	array(
		array('name' => 'subjectarea_name',
              'title' => 'Name',
              'description' => 'Name field',
              'type' => 'text',
        ),
        array('name' => 'subjectarea_code',
              'title' => 'Code',
	...
	{
	 register_post_type('content_subjects', 
			array(
				'label' => 'Subject Areas',
				'labels' => array(
					'add_new' 			=> 'Add New',
					...
					'search_items'		=> 'Search subject areas',
					'not_found'			=> 'No subject area Found',
					'not_found_in_trash'=> 'Not Found in Trash',
				),
				'description' => 'Reusable subject area of content',
				'public' => true,
				'show_ui' => true,
				'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'content_subjects') 
        {
