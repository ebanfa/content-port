...
class ContentTypeOfDocumentCPT {

    public static $prefix = ''; 

	public static $custom_fields =	array(
		array('name' => 'doctype_name',
              'title' => 'Name',
              'description' => 'Name field',
              'type' => 'text',
        ),
        array('name' => 'doctype_code',
              'title' => 'Code',
	...
	{
	 register_post_type('content_doctypes', 
			array(
				...
				'description' => 'Reusable document type of content',
				'public' => true,
				'show_ui' => true,
				'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'content_doctypes') 
        {
