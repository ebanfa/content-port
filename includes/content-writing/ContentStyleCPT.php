...
class ContentStyleCPT {
	...
	{
	 register_post_type('content_styles', 
			array(
				'label' => 'Styles',
				'labels' => array(
					'add_new' 			=> 'Add New',
					...
					'not_found'			=> 'No Style Found',
					'not_found_in_trash'=> 'Not Found in Trash',
				),
				'description' => 'Reusable Style of content',
				'public' => true,
				'show_ui' => true,
				'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'content_styles') 
        {
